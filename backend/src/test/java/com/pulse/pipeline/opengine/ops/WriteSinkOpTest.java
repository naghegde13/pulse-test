...
/** write-sink (SPEC #1 §B.1 rule 26) — schema passthrough. */
class WriteSinkOpTest {

    private final WriteSinkOp op = new WriteSinkOp();
    ...
    void opNameIsCanonical() {
        assertEquals(OpVocabulary.WRITE_SINK, op.opName());
    }
